...
native classes. Eligible speakers within each recorded-sex stratum are
hash-ranked using phase, corpus, draw, and fold identifiers; successive
equal quotas form A and B, without model scores.
All query groups share texts disjoint from fit texts
...
\begin{figure*}[t]
\centering
\includegraphics[width=178mm]{../../figure-revision-20260907/figures/complete_epoch_curves.pdf}
...
A post hoc reconstruction restricting candidates to epochs 1--8, 1--10, 1--12, or 1--15 shows window-sensitive contrasts~\cite{artifact}; it adds no tests and cannot establish behavior beyond epoch 15.
...
Separate recording-budget and coverage studies, and the synthetic-speech protocol that did not reach formal training, remain in the artifact~\cite{artifact}; they provide no pooled confirmation or demonstrated elimination of the seen--unseen gap.
